...
var (
	_ ephemeral.EphemeralResource = &KubernetesEphemeral{}
)

func NewKubernetesEphemeral() ephemeral.EphemeralResource {
	return &KubernetesEphemeral{}
}
...
func (d *KubernetesEphemeral) Schema(ctx context.Context, req ephemeral.SchemaRequest, resp *ephemeral.SchemaResponse) {
...
func (d *KubernetesEphemeral) Close(ctx context.Context, req ephemeral.CloseRequest, resp *ephemeral.CloseResponse) {
